...
theme.set_highlights = function()
  ...
  hl(0, "TabLineFill", { fg = c.line, bg = c.alt_bg })
  ...
  hl(0, "@tag.delimiter", { fg = c.context, bg = 'NONE' })
  ...
  hl(0, "NvimTreeCursorLine", { fg = 'NONE', bg = c.cursor_ln })
  ...
  -- Buffer
  hl(0, "BufferCurrent", { fg = c.hint, bg = c.bg })
  hl(0, "BufferCurrentIndex", { fg = c.hint, bg = c.bg })
  ...
  hl(0, "BufferVisible", { fg = c.hint, bg = c.bg })
  ...
  hl(0, "BufferInactive", { fg = c.light_gray, bg = c.alt_bg })
  hl(0, "BufferInactiveIndex", { fg = c.blue, bg = c.alt_bg })
  ...
  hl(0, "NavicText", { fg = c.light_gray, bg = 'NONE' })
